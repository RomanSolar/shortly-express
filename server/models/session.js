...
class Sessions extends Model {
   ...
   * @returns {Promise<string>} A promise that is fulfilled with the results of
   ...
   * a delete query or rejected with the error that occured.
   */
  destroy(hash) {
    return super.delete.call(this, { hash });
  }

  /**
   * Associates a hash with a user.
   * @returns {Promise<Object>} A promise that is fulfilled with the results of
   * an update query or rejected with the error that occured.
   */
  associate(hash, userId) {
    return super.update.call(this, { hash }, { userId });
  }
}
